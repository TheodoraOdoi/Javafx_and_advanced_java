...
/**
 * Java program to demonstrate thread locking & synchronisation.
 * 
 * @author todoi
 */
public class SynchronisationDemo
{
    ...
    {
        // Declare & instantiate a counter object
        ...
        // Create the 2nd thread that will access the increment() method concurrently
        Thread t2 = new Thread(() ->
        {
            ...
            System.out.println("Thread 2 local count: " + thread1Count[0]);
        });
        ...
        //Print the final count(expected to be 2000 if synchronisation worked correctly)
        System.out.println("Final counter value after synchronisation: " + counter.getCount());
    }
