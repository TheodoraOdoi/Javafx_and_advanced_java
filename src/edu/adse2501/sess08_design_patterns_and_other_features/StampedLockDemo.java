 ...
 * resource, in this case, a balance amount. This StampedLock allowsmboth read
 * & write operations with diff levels of locking:
 * -Write lock: used for exclusive modifications.
 * -Read lock: used for shared access without modification.
 * -Optimistic read lock: used for non-blocking reads, allowing readers to 
 * proceed unless a write occurs
 * 
 * This class demonstrates locking mechanisms through deposit, withdraw & 
...
public class StampedLockDemo
{
    ...
    public void withdraw(double amount)
    {
       System.out.println("\nAbout to withdraw Kes. : " + amount);
        ...
        {
            stampedLock.unlock(stamp); // release the  write lock
            System.out.println("Unlock write lock");
        }
    }
    ...
    public double checkBalanceOptimisticRead()
    {
        ...
        // validate if a write occurred during the optimistic read
       ...
       System.out.println("\nAvailable balance Kes.: " + currentBalance);
    ...
    public static void main(String[] args)
    {
        ...
        // perform a seris of transactions
        stampedLockDemo.withdraw(1000.0); //withdraw Kes. 1000.00
        stampedLockDemo.deposit(5000.0); // Deposite Kes. 5000.00
        stampedLockDemo.checkBalance(); // Check balance with read lock
        stampedLockDemo.checkBalanceOptimisticRead(); // ckeck balance with optimistic read lock
    }
}
