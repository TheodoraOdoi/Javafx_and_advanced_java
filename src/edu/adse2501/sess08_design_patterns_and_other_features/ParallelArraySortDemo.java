...
/**
 * This program demonstrates how to sort an array of random float numbers(100)
 * using parallelSort() method from the Arrays class in Java. it shows the 
...
public class ParallelArraySortDemo
{
    public static void main(String[] args)
    {
        ...
        for(int n = 0; n < array.length; n++)
            array[n] = random.nextFloat() * 1000; //random floats btw. 0-1000
        
        //Display the random numbers b4  sorting
    ...
    {
        for(float num: array)
            System.out.printf("%.2f ", num); // print each no. correct to 2 d.p.
