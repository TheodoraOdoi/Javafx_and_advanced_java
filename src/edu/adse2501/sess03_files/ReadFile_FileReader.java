...
public class ReadFile_FileReader
{
    ...
    {
        // Use a try with the resources to automatically close all open handles later
        try(FileReader freader = new FileReader(new File(new ReadFile_FileReader().url2File .getPath())))
        {
            int n;
